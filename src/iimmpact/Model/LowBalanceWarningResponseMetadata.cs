...
namespace iimmpact.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LowBalanceWarningResponseMetadata :  IEquatable<LowBalanceWarningResponseMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LowBalanceWarningResponseMetadata" /> class.
        /// </summary>
        /// <param name="status_code">status_code.</param>
        /// <param name="last_updated">last_updated.</param>
        public LowBalanceWarningResponseMetadata(string status_code = default(string), string last_updated = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LowBalanceWarningResponseMetadata {\n");
        ...
        {
            return this.Equals(input as LowBalanceWarningResponseMetadata);
        }

        /// <summary>
        /// Returns true if LowBalanceWarningResponseMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of LowBalanceWarningResponseMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LowBalanceWarningResponseMetadata input)
        {
            if (input == null)
                return false;
